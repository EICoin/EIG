...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About EI", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>EI</b> version", 0));
...
"Copyright \302\251 2014 The EI developers", 0));
